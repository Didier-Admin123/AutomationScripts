...
Get-WMIObject -class Win32_ComputerSystem -computer $username | Select UserName,Manufacturer,Model | convertto-html -head $a 
Get-wmiobject win32_bios -Computer $username | select serialnumber,version | convertto-html -head $a 