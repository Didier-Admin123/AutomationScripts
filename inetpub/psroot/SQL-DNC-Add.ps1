...
if($dev -contains $number){echo "<div style=float:left><h4><span style=color:red>$number</span> Was Added To The <span style=color:red>$line</span> DNC List<h4></div>"}
else{echo "<div style=float:left><h4><span style=color:red>$number</span> Was Not Added To The <span style=color:red>$line</span> DNC List<h4></div>"}