...
<div id="wrapper" >
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="changepin.php">Change Secure Pin </a>
                            </li>
							<li>
                                <a href="adpage-pwreset.php">Reset Password </a>
                            </li>
                        </ul>
                    </li>
                </ul>
    ...
    <div id="page-wrapper">
        <div class="container-fluid" >
            ...
            <div class="row" >
                <div class="col-lg-12">
                    <h1 class="page-header">Self Service Portal</h1>
                </div>
            </div>
	 ...
	 <p>
	  <a target="_self" href="adpage-pwreset.php">
	   <img src="icons/add.ico" width="100" height="100" style="border: 0px">
	  </a>
	  <div class="desc"> Password Reset </div>
	 </p>
	</div> 	
		
		<div class="img" style="height:160px">
	 <p>
	  <a target="_self" href="https://tbc.service-now.com/Empereon">
	   <img src="icons/servicenow.ico" width="100" height="100" style="border: 0px">
	  </a>
	  <div class="desc"> Service Now </div>
	 </p>
	</div> 		
