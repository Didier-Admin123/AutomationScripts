...
<!-- USER INPUT BOX-->
						<div class="form" >
						  <form action="validation.php" target="_self" method="post" >
							<label for="fname"><img id="imghdr" src="pics/logo.png" height="100" /></label><br>
							...
							<input type="password" name="code" required id="code"    /><label ><a ><font size="2" >Forgot Secure Pin</font></a></label><br>
...
function logout() {
	...
	<p>&copy;<?php echo date('Y');?> Empereon Marketing<br/>
								<img src="icons/emplogo.png" style="box-shadow: 0 0 5px 2px rgba(0,0,0,.35);height:50px;width:200px" >			
								</div>
</html>
