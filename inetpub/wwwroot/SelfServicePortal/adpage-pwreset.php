...
<div id="wrapper">
        ...
        <ul class="nav navbar-right navbar-top-links">
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    <i class="fa fa-user fa-fw"></i> <?php echo "<span style=color:#ff6666>$_COOKIE[username]</span>"?><b class="caret"></b>
                </a>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="pincode.php">Change Secure Pin </a>
                            </li>
                        </ul>
                    </li>
                </ul>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Self Service Active Directory <img src="icons/add.ico" width="40" height="40" style="border:0px"></h1>
                </div>
            </div>
		...
		<!-- ... Your Application Below                                     -->
						...
						<div class="form" >
						  <form target="_self" method="post" name="form" >
							...
							<input type="text" name="username" required id="username" value="<?php echo "$_COOKIE[username]"?>" readonly maxlength="20" />
...
if($_POST['btnSubmit'] == 'Set Password'){
    ...
    $psScriptPath = "C:\inetpub\psroot\setpassword-serviceportal.ps1";
    $query = shell_exec("powershell -command $psScriptPath -user '$user' -username '$username' -password '$password'< NUL");
    file_put_contents("C:\cloudAppLogs\Self_Service-PasswordReset.txt","A Password was Initiated for $_COOKIE[username] by $_COOKIE[username] on $ipaddress at $time on $date\r\n ",FILE_APPEND);
	echo $query; 
