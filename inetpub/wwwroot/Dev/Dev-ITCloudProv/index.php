...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style=" box-shadow: 0 0 5px 2px rgba(0,0,0,.35)">
       ...
       <a class="navbar-brand" style="color:#ff6666">Empereon Marketing</a>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">IT CloudApps</h1>
                </div>
            </div>
...
<!-- 	<div class="img" style="height:160px">
	  <p>
	   <a target="_self" href="advadpage.php">
		<img src="icons/advad.ico" width="100" height="100" style="border: 0px">
	   </a>
	...
	<div class="img" style="height:160px">
	 <p>
	   <a target="_self" href="scan.php">
		 <img src="icons/scanner.ico" width="100" height="100" style="border: 0px">
	   </a>
	  <div class="desc"> ScanFolder Provisioning </div>
	 </p>
	</div>
	<!---BOX---->
	<div class="img" style="height:160px">
	 <p>
	   <a target="_self" href="sql-dnc.php">
		<img src="icons/dnc.ico" width="100" height="100" style="border: 0px">
	   </a>
