...
<html>
<head>
<title>PHP PowerShell Testing</title>
</head>
<body>
<div>
<h1> HelpDesk Tool Dev</h1>
...
if(!isset($_POST["submit"]))
{
    ...
    <form name="testForm" id="testForm" action="get-process.php" method="post" />
        User Name: <input type="text" name="username" id="username" maxlength="20" /><br />
...
elseif((isset($_POST["submit"])) && (!empty($_POST["username"])))
{
    ...
    $psScriptPath = "C:\inetpub\psroot\get-process.ps1";
