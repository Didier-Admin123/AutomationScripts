...
<!-- Query Locked Users Buttom--> 
	...
	<input type="submit" name="btnSubmit" id="btnSubmit" value="Query" />
     ...
     <div class="img">
    <form name="testForm" id="testForm" target="_self" method="post" /> Check Who's Loggon On To A Computer :
	<input type="text" name="username"  maxlength="20" /> IP or PC-Name
	<a target="_self" title="Using IP Is More Efficient">
